...
<script>
    ...
    // On load, set default to "dalam kota" or first
    document.addEventListener('DOMContentLoaded', function() {
        const buttons = document.querySelectorAll('.timetable-btn');
        let defaultBtn = null;
        
        // Cari button dengan text mengandung "dalam kota"
        buttons.forEach(btn => {
            if (btn.textContent.trim().toLowerCase().includes('dalam kota')) {
                defaultBtn = btn;
            }
        });
        
        // Jika tidak ada, gunakan yang pertama
        ...
        if (defaultBtn) {
            ...
            updatePDF(defaultBtn.dataset.typeId);
        }
    });
</script>
